...
```bash
npx @sebastienrousseau/password-generator -t strong -l 12 -i 3 -s '-' -c
```
...
```bash
npx @sebastienrousseau/password-generator -t strong -l 16 -i 4 -s '' -c
```
...
```bash
npx @sebastienrousseau/password-generator -t strong -l 14 -i 3 -s '_'
```
...
```bash
npx @sebastienrousseau/password-generator -t base64 -l 24 -i 2 -s '.'
```
...
```bash
npx @sebastienrousseau/password-generator -t strong -l 14 -i 2 -s '@'
```
...
```bash
npx @sebastienrousseau/password-generator -t strong -l 20 -i 3 -s ''
```
...
```bash
npx @sebastienrousseau/password-generator -t base64 -l 28 -i 1 -s ''
```
...
```bash
npx @sebastienrousseau/password-generator -t strong -l 24 -i 2 -s '_'
```
...
```bash
npx @sebastienrousseau/password-generator -t base64 -l 32 -i 2 -s ''
```
...
```bash
npx @sebastienrousseau/password-generator -t strong -l 12 -i 2 -s '' -a
```
**Output:** `aB3dEf+/gH1iKl2MnOpQr3stU4vWxYz5A6b`
...
```bash
npx @sebastienrousseau/password-generator -t strong -l 12 -i 3 -s '-' -a
```
**Output:** `aB3dEf+/gH1i-Kl2MnOpQr3s-tU4vWxYz5A6`
...
```bash
npx @sebastienrousseau/password-generator -t strong -l 16 -i 3 -s '' -a
```
...
```bash
npx @sebastienrousseau/password-generator -t strong -l 14 -i 3 -s '-' -c
```
...
```bash
npx @sebastienrousseau/password-generator -t quantum-resistant -l 32 -i 4 --kdf-memory 131072 --kdf-time 5 --kdf-parallelism 8
```
...
```bash
npx @sebastienrousseau/password-generator --preset quick
```
...
```bash
npx @sebastienrousseau/password-generator --preset secure
```
**Output:** `aB3dEf+/gH1iKl2MnOpQr3stU4vWxYz5A6bC7dEf+/gH1iKl2MnOp`
...
```bash
npx @sebastienrousseau/password-generator --preset memorable
```
**Output:** `Apple-Bridge-Castle-Dragon`
...
```bash
npx @sebastienrousseau/password-generator --preset quantum
```
**Output:** `QR$v9K#mF2@x7L&nE8!pX3@T5w$nM9&bE8!tZ7%L4@nF6#mR2$w`
