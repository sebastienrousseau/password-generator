...
describe('Generators: memorable', () => {
  describe('generateMemorablePassword', () => {
    it('should generate password with single word', async () => {
      ...
      const result = await generateMemorablePassword({ iteration: 1, separator: '-' }, mock, dict);
    ...
    it('should generate password with multiple words', async () => {
      ...
      const result = await generateMemorablePassword({ iteration: 3, separator: '-' }, mock, dict);
    ...
    it('should use custom separator', async () => {
      ...
      const result = await generateMemorablePassword({ iteration: 2, separator: ' ' }, mock, dict);
    ...
    it('should throw RangeError for zero iteration', async () => {
      ...
      try {
        await generateMemorablePassword({ iteration: 0, separator: '-' }, mock, dict);
    ...
    it('should throw RangeError for negative iteration', async () => {
      ...
      try {
        await generateMemorablePassword({ iteration: -2, separator: '-' }, mock, dict);
        expect.fail('Should have thrown');
      } catch (e) {
        expect(e).to.be.instanceOf(RangeError);
      }
    ...
    it('should throw error for empty dictionary', async () => {
      ...
      try {
        await generateMemorablePassword({ iteration: 1, separator: '-' }, mock, dict);
        expect.fail('Should have thrown');
      } catch (e) {
    ...
    it('should work with DEFAULT_WORD_LIST', async () => {
      ...
      const result = await generateMemorablePassword({ iteration: 4, separator: '-' }, mock, dict);
    ...
    it('should handle 6 words (typical passphrase)', async () => {
      ...
      const result = await generateMemorablePassword({ iteration: 6, separator: '-' }, mock, dict);
  ...
  describe('generatePassphrase', () => {
    describe('basic functionality', () => {
      it('should generate basic passphrase', async () => {
        ...
        const result = await generatePassphrase({ iteration: 2, separator: '-' }, mock, dict);
      ...
      it('should use custom separator', async () => {
        ...
        const result = await generatePassphrase({ iteration: 2, separator: '_' }, mock, dict);
    ...
    describe('error handling', () => {
      it('should throw for empty dictionary', async () => {
        ...
        try {
          await generatePassphrase({ iteration: 1, separator: '-' }, mock, dict);
          expect.fail('Should have thrown');
        } catch (e) {
          expect(e.message).to.include('empty');
        }
      ...
      it('should throw for zero iteration', async () => {
        ...
        try {
          await generatePassphrase({ iteration: 0, separator: '-' }, mock, dict);
          expect.fail('Should have thrown');
        } catch (e) {
          expect(e).to.be.instanceOf(RangeError);
        }
  ...
  describe('Edge cases', () => {
    describe('Empty dictionary handling', () => {
      it('should throw error when dictionary returns null', async () => {
        ...
        try {
          await generateMemorablePassword({ iteration: 1, separator: '-' }, mock, nullDict);
          expect.fail('Should have thrown');
        } catch (e) {
      ...
      it('should throw error when dictionary returns undefined', async () => {
        ...
        try {
          await generateMemorablePassword({ iteration: 1, separator: '-' }, mock, undefinedDict);
          expect.fail('Should have thrown');
        } catch (e) {
          expect(e.message).to.equal('Dictionary is empty or not loaded');
        }
      ...
      it('should throw for generatePassphrase with null dictionary', async () => {
        ...
        try {
          await generatePassphrase({ iteration: 1, separator: '-' }, mock, nullDict);
          expect.fail('Should have thrown');
        } catch (e) {
          expect(e.message).to.equal('Dictionary is empty or not loaded');
        }
